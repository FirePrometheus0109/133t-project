...
@Component({
  ...
  template: `
    <mat-card>
      <mat-card-title>Company Signup</mat-card-title>
      <mat-card-content>
        <form [formGroup]="form" ngxsForm="companysignup.form" ngxsFormClearOnDestroy="true" (ngSubmit)="submit()">
          <p>
            <mat-form-field>
          ...
          <mat-button-toggle-group class="signupButtons">
            ...
            <button type="submit" mat-raised-button color="primary" [disabled]="form.invalid">SignUp as Company</button>
...
export class CompanySignupComponent extends BaseFormComponent {
  ...
  form: FormGroup = new FormGroup({
    ...
    company_name: new FormControl('', Validators.compose([Validators.required, Validators.maxLength(InputLengths.names)])),
  });
