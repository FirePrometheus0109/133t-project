...
NOTIFICATION_COMPANY_USER_VERBS_DATA = (
    {
        'name': constants.NOTIFICATION_VERB_PACKAGE_PRICE_CHANGED,
        'type': constants.NOTIFICATION_TYPE_PRICE_CHANGES
    },
)
...
def create_notifications_types(type_model):
    ...
    for notif_format in formats:
        type_, _ = type_model.objects.get_or_create(
            format=notif_format,
            name=constants.NOTIFICATION_TYPE_PRICE_CHANGES
        )
        types.append(type_)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('notification_center', '0005_subscription_plan_notifications'),
    ]
